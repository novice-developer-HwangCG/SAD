...
class ImageToggleButton(tk.Frame):
    ...
    def toggle(self):
        ...
        if self.variable_name == "ARM_1":
            ...
            self.send_signal_to_pico("ARM_1", ImageToggleButton.ARM_1)
        else:
            # 다른 버튼들 처리
    ...
    def update_button_display(self):
        ...
        current_status = getattr(ImageToggleButton, self.variable_name)
        ...
        status = "HIGH" if current_status else "LOW"
