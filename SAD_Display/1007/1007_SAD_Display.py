...
for i, variable_name in enumerate(["ARM_1", "ARM_2", "ARM_3", "FIRE"]):
    ...
    toggle_button = ImageToggleButton(
        root,
        on_image_path="/home/jetpack/Desktop/sad_test/toggle_on.png",
        off_image_path="/home/jetpack/Desktop/sad_test/toggle_off.png",
...
toggle_diar = DiarToggleButton(
    root,
    diar_on_image_path="/home/jetpack/Desktop/sad_test/diar_sw1_1.png",
    diar_off_image_path="/home/jetpack/Desktop/sad_test/diar_sw2_2.png",
    label=diar_label
)
